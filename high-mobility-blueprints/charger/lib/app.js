...
var hmkit = new _hmkit2.default("dGVzdN/pqZTc4SBbVrCNLgshNVHe8aPqZtB0kPjNzP6tQKWkHd1ahOTBZ5HZE3rVhi/kUPFjYXTaJaZ3DiwFsvmvGEqYOjCsqFTlDH7BGVZm2ZweIOMWbKfLoV2uFHav1NKWNCCONQ/uHR5I9SfAONK90ukvBZZYyTOCKNHknES8sHnFXK5/KWBQ+7gJzV3lFyGpqS441EBp", "9SwqaZryNgRxCy8X+u+XwRi+ssEYlVVVd08Y4BiEcGE=");
...
var vehicleSeed = 'QRSGEWIDNYJPPCUKBMSVLZOTMLNEJPAQMOXJATGCTQNPJYDBWARB99CXQZYCBSNZJALYXPXDHOOLPHAMT';

// The access certificate for our vehicle simulator is defined here
// FIXME: Change to your own Vehicle Access Token
var accessTokenVehicle = '3c279690-8550-4477-bf95-06946e7f0b34';

// The IOTA seed for your vehicle is defined here
// FIXME: Check the readme for information on how to generate a seed
var chargerSeed = 'URZKIZJZ9LT9ST9JGKEHPXOIZEMFSF9SCUKKPBATSO9KH9OFNRYNGLLVZMTUCMUJVRDJERWEFNFRM9MBX';

// The access certificate for our charger simulator is defined here
// FIXME: Change to your own Charger Access Token
var accessTokenCharger = 'da5cfb1d-ffc5-4aff-be0e-db3f69a8a926';
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 17:
                return _context9.abrupt('return', callback('Error: Timeout. Please check if transaction is pending and promote / reattach.'));
